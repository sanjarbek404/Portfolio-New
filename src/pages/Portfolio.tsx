  ...
  return (
    ...
    >
      {[
        ...
        { type: 'fire', icon: <Flame size={18} />, count: reactions.fire, color: "text-orange-500" },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-4 gap-4 auto-rows-[280px]">
          <BentoCard 
            ...
            title={settings?.aboutTitle || "Sodda. Kreativ. Samarali."}
            fullContent={
              <div className="space-y-6">
                <Layers className="text-blue-500 mb-4" size={48} />
                <h3 className="text-4xl font-bold dark:text-white">{settings?.aboutTitle || "Sodda. Kreativ. Samarali."}</h3>
                <p className="text-xl text-gray-500 dark:text-gray-400 leading-relaxed whitespace-pre-wrap">
                  {settings?.aboutFull || "Dasturlash men uchun shunchaki kod yozish emas, balki insonlar hayotini yengillashtiruvchi vositalar yaratishdir. Har bir loyihada minimalizm va yuqori unumdorlikni birinchi o'ringa qo'yaman.\n\nMening maqsadim - foydalanuvchi interfeyslarini shunchalik sodda qilishki, hatto birinchi marta kirgan odam ham o'zini uydagidek his qilsin. Murakkab muammolarga kreativ yechimlar topish mening asosiy kuchimdir."}
                </p>
              </div>
            }
          >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl md:text-4xl font-bold text-[#1d1d1f] dark:text-white mb-6 tracking-tight">{settings?.aboutTitle || "Sodda. Kreativ. Samarali."}</h3>
                <p className="text-[#86868b] dark:text-gray-400 leading-relaxed text-lg md:text-xl font-light">
                  {settings?.aboutShort || "Dasturlash men uchun shunchaki kod yozish emas, balki insonlar hayotini yengillashtiruvchi vositalar yaratishdir."}
                </p>
              </div>
          </BentoCard>
          ...
          <BentoCard className="md:col-span-2 md:row-span-1" title="GitHub">
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              ...
              <div>
                <p className="text-sm text-[#86868b] dark:text-gray-400 font-medium tracking-widest uppercase mb-2">GitHub Stats</p>
                <div className="flex items-end gap-2">
                  ...
                  <p className="text-sm text-green-500 font-medium mb-1">+ Commits</p>
                </div>
                <p className="text-sm text-[#86868b] dark:text-gray-400 mt-2">{settings?.githubYearText || "Bu yilgi faollik"}</p>
              </div>
            </div>
          </BentoCard>
          ...
          <BentoCard className="md:col-span-2 md:row-span-1" title="Spotify">
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              ...
              <div>
                <p className="text-sm text-[#86868b] dark:text-gray-400 font-medium tracking-widest uppercase mb-2">Hozir tinglayapman</p>
